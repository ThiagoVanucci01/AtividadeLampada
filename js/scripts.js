...
const gerarImagem = () => {
  ...
  for (let i = 1; i <= qtdImagem; i++) {
    canvas.innerHTML += `<img class="imagens"  id="lampada" src="img/apagada.jpg" alt"Lampada">`;
  }
};
//-----------------------------//
const calcular = () => {
